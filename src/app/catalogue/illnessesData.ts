export const illnessesData = [
    {
        name: "Fungal infection",
        description: "A disease caused by fungi that can affect various parts of the body.",
        treatments: [
            {
        ...
        outlook: "Generally good with proper treatment, but may recur in some cases.",
        duration: "Varies from a few days to several weeks, depending on the type and location of the infection.",
        aggravatingFactors: ["Humid environments", "Poor hygiene", "Weakened immune system"]
    },
    {
        name: "Allergy",
        description: "An immune system response to a substance that's typically harmless.",
        treatments: [
            {
                name: "Antihistamines",
                effectiveness: 75,
        ...
        aggravatingFactors: ["Exposure to allergens", "Stress", "Changes in weather"]
    },
    {
        name: "GERD",
        ...
        outlook: "Can be effectively managed with treatment, but may require long-term care.",
        duration: "Often a chronic condition requiring ongoing management.",
        aggravatingFactors: ["Spicy foods", "Fatty foods", "Lying down after eating"]
    },
    {
        ...
        outlook: "Varies depending on the underlying cause, may require long-term management.",
        duration: "Often chronic, but can be acute in some cases.",
        aggravatingFactors: ["Certain medications", "Pregnancy", "Genetic factors"]
    },
    {
        name: "Drug Reaction",
        description: "An unexpected reaction to a medication, ranging from mild to severe.",
        treatments: [
            {
        ...
        outlook: "Generally good once the offending drug is identified and discontinued.",
        duration: "Can range from hours to weeks after drug discontinuation.",
        aggravatingFactors: ["Continued use of offending drug", "Multiple drug interactions", "Genetic predisposition"]
    },
    {
        name: "Peptic ulcer diseae",
        description: "Open sores that develop on the inside lining of the stomach and small intestine.",
        treatments: [
            {
                name: "Proton Pump Inhibitors",
                effectiveness: 85,
        ...
        outlook: "Generally good with proper treatment, but recurrence is possible.",
        duration: "Healing typically occurs within 4-8 weeks with treatment.",
        aggravatingFactors: ["Stress", "Smoking", "Alcohol consumption", "Certain medications (e.g., NSAIDs)"]
    },
    {
        name: "AIDS",
        ...
        outlook: "Greatly improved with modern treatments, but remains a lifelong condition.",
        duration: "Lifelong condition requiring ongoing management.",
        aggravatingFactors: ["Non-adherence to medication", "Untreated opportunistic infections", "Substance abuse"]
    },
    {
        name: "Diabetes",
        ...
        outlook: "Can be effectively managed but requires lifelong care and monitoring.",
    ...
    },
    {
        ...
        outlook: "Generally good, with most cases resolving within a few days to a week.",
        duration: "Usually lasts 1-3 days, but can persist for up to 10 days.",
        aggravatingFactors: ["Poor hygiene", "Contaminated food or water", "Close contact with infected individuals"]
    },
    {
        ...
        outlook: "Can be effectively managed but requires ongoing care and monitoring.",
        duration: "Chronic condition with intermittent acute episodes.",
        aggravatingFactors: ["Allergens", "Air pollution", "Respiratory infections", "Exercise", "Stress"]
    },
    {
        name: "Hypertension",
        description: "A chronic condition characterized by persistently elevated blood pressure in the arteries.",
        treatments: [
            {
                name: "ACE Inhibitors",
                effectiveness: 75,
        ...
        outlook: "Can be managed effectively with medication and lifestyle changes, but requires lifelong monitoring.",
        duration: "Chronic condition requiring ongoing management.",
        aggravatingFactors: ["High sodium diet", "Lack of exercise", "Obesity", "Stress", "Genetics", "Smoking", "Alcohol consumption"]
    },
    {
        name: "Migraine",
        ...
        treatments: [
            ...
            },
            {
                ...
                effectiveness: 65,
                sideEffects: ["Constipation", "Muscle cramps", "Injection site reactions"]
            }
        ],
        outlook: "Can be managed with medication and lifestyle changes, but may be a lifelong condition.",
        duration: "Episodes can last from hours to days.",
        aggravatingFactors: ["Stress", "Hormonal changes", "Certain foods and drinks", "Lack of sleep", "Bright lights", "Loud noises"]
    },
    {
        ...
        outlook: "Can be managed with conservative treatments, but may worsen over time.",
        duration: "Chronic condition, symptoms may fluctuate.",
        aggravatingFactors: ["Poor posture", "Repetitive neck movements", "Trauma", "Age"]
    },
    {
        ...
        treatments: [
            {
                ...
                effectiveness: 80,
                sideEffects: ["Infection risk", "Complications from anesthesia", "Further brain damage"]
            },
            {
        ...
        outlook: "Varies greatly depending on the severity and location of the hemorrhage.",
        duration: "Can be permanent or temporary, depending on the extent of the damage.",
        aggravatingFactors: ["High blood pressure", "Aneurysms", "Blood clotting disorders", "Trauma"]
    },
    {
        name: "Jaundice",
        description: "A condition causing yellowing of the skin and whites of the eyes due to a buildup of bilirubin in the blood.",
        treatments: [
            {
                name: "Phototherapy",
                effectiveness: 85,
        ...
        outlook: "Depends entirely on the underlying cause; treatment focuses on resolving the root issue.",
        duration: "Varies depending on the underlying cause and its treatment.",
        aggravatingFactors: ["Liver disease", "Gallstones", "Certain medications", "Genetic disorders"]
    },
    {
        name: "Malaria",
        description: "A serious mosquito-borne disease caused by a parasite, leading to flu-like symptoms and potential complications.",
        treatments: [
            {
        ...
        outlook: "Generally good with prompt treatment, but can be life-threatening if left untreated.",
        duration: "Symptoms typically last for a week or two, but complications can arise.",
        aggravatingFactors: ["Mosquito bites", "Travel to malaria-endemic areas", "Weakened immune system"]
    },
    {
        name: "Chicken pox",
        ...
        aggravatingFactors: ["Close contact with infected individuals", "Weakened immune system"]
    },
    {
        name: "Dengue",
        ...
        aggravatingFactors: ["Mosquito bites", "Travel to dengue-endemic areas", "Weakened immune system"]
    },
    {
        name: "Typhoid",
        ...
        aggravatingFactors: ["Contaminated food or water", "Poor hygiene", "Weakened immune system"]
    },
    {
        name: "Hepatitis A",
        ...
        aggravatingFactors: ["Contaminated food or water", "Poor hygiene", "Close contact with infected individuals"]
    },
    {
        name: "Hepatitis B",
        ...
        outlook: "Varies, some clear the infection while others develop chronic hepatitis B.",
        duration: "Acute infection can last for several weeks to months; chronic infection is lifelong.",
        aggravatingFactors: ["Exposure to infected blood or bodily fluids", "Sexual contact with infected individuals", "Sharing needles"]
    },
    {
        name: "Hepatitis C",
        ...
        outlook: "Highly curable with direct-acting antivirals, but chronic infection can lead to cirrhosis and liver cancer.",
        duration: "Acute infection can resolve spontaneously, but chronic infection is lifelong.",
        aggravatingFactors: ["Exposure to infected blood or bodily fluids", "Sharing needles", "Sexual contact with infected individuals"]
    },
    {
        name: "Hepatitis D",
        description: "A serious liver disease caused by the hepatitis D virus (HDV), which only occurs in people who are infected with hepatitis B.",
        treatments: [
            {
        ...
        outlook: "Poor prognosis, often leading to chronic liver disease and cirrhosis.",
        duration: "Lifelong condition.",
        aggravatingFactors: "Co-infection with Hepatitis B"
    },
    {
        name: "Hepatitis E",
        description: "A liver disease caused by the hepatitis E virus, typically self-limiting but can be severe in certain populations.",
        treatments: [
            {
                name: "Supportive Care",
                effectiveness: 90,
        ...
        outlook: "Generally good, with most cases resolving spontaneously, but can be severe in pregnant women and those with underlying liver disease.",
        duration: "Acute infection typically resolves within a few weeks.",
        aggravatingFactors: ["Contaminated food or water", "Travel to Hepatitis E-endemic areas", "Pregnancy", "Weakened immune system"]
    },
    {
        name: "Alcoholic hepatitis",
        description: "Liver inflammation caused by drinking too much alcohol, potentially leading to liver failure and death.",
        treatments: [
            {
                name: "Corticosteroids",
                effectiveness: 60,
        ...
        outlook: "Varies depending on the severity of the disease and the individual's response to treatment.",
        duration: "Can be acute or chronic, depending on the extent of liver damage.",
        aggravatingFactors: ["Excessive alcohol consumption", "Poor nutrition", "Other liver diseases"]
    },
    {
        name: "Tuberculosis",
        ...
        outlook: "Generally good with proper treatment, but drug-resistant strains can be challenging to treat.",
        duration: "Treatment typically lasts for several months.",
        aggravatingFactors: ["Weakened immune system", "Close contact with infected individuals", "Poor living conditions"]
    },
    {
        name: "Common Cold",
    ...
    },
    {
        ...
        outlook: "Generally good with prompt treatment, but can be life-threatening in severe cases.",
        duration: "Can last for several weeks, depending on the severity and type of pneumonia.",
        aggravatingFactors: ["Weakened immune system", "Underlying lung conditions", "Exposure to bacteria or viruses"]
    },
    {
        name: "Dimorphic hemorrhoids(piles)",
        description: "Swollen and inflamed veins in the rectum and anus that can cause discomfort and bleeding.",
        treatments: [
            {
        ...
        duration: "Varies, some resolve spontaneously while others require treatment.",
        aggravatingFactors: ["Constipation", "Straining during bowel movements", "Pregnancy", "Obesity"]
    },
    {
        name: "Heart attack",
        ...
        outlook: "Varies depending on the extent of heart damage and promptness of treatment.",
        duration: "Requires immediate medical attention; recovery time varies.",
        aggravatingFactors: ["High blood pressure", "High cholesterol", "Smoking", "Diabetes", "Family history"]
    },
    {
        name: "Varicose veins",
        ...
        treatments: [
            {
                name: "Sclerotherapy",
                effectiveness: 80,
                sideEffects: ["Skin discoloration", "Inflammation", "Blood clots (rare)"]
            },
            {
        ...
        outlook: "Can be managed effectively, but may worsen over time if left untreated.",
        duration: "Chronic condition.",
        aggravatingFactors: ["Prolonged standing or sitting", "Pregnancy", "Family history", "Obesity"]
    },
    {
        name: "Hypothyroidism",
        ...
        aggravatingFactors: ["Autoimmune diseases", "Iodine deficiency", "Thyroid surgery", "Radiation therapy"]
    },
    {
        ...
        outlook: "Can be effectively managed with medication or radioactive iodine therapy.",
        duration: "Can be temporary or lifelong, depending on the cause.",
        aggravatingFactors: ["Autoimmune diseases", "Graves' disease", "Thyroid nodules", "Thyroid cancer"]
    },
    {
        name: "Hypoglycemia",
        description: "A condition characterized by abnormally low blood glucose (sugar) levels.",
        treatments: [
            {
        ...
        aggravatingFactors: ["Diabetes medication", "Skipping meals", "Excessive alcohol consumption", "Strenuous exercise"]
    },
    {
        name: "Osteoarthritis",
    ...
    },
    {
        ...
        treatments: [
            {
                ...
                effectiveness: 80,
                sideEffects: ["Increased infection risk", "Liver damage", "Lung problems"]
            },
            {
                name: "Corticosteroids",
                effectiveness: 75,
        ...
        aggravatingFactors: ["Genetics", "Autoimmune diseases", "Infections", "Joint injury"]
    },
    {
        name: "(vertigo) Paroxysmal Positional Vertigo",
        description: "A disorder of the inner ear characterized by episodes of dizziness and a sensation of spinning.",
        treatments: [
            {
                name: "Epley Maneuver",
                effectiveness: 80,
        ...
        aggravatingFactors: ["Head position changes", "Inner ear infections", "Head trauma"]
    },
    {
        name: "Acne",
        ...
        treatments: [
            {
                ...
                effectiveness: 70,
                sideEffects: ["Skin irritation", "Increased sun sensitivity", "Dryness"]
            },
            {
                name: "Oral Antibiotics",
                effectiveness: 75,
                sideEffects: ["Nausea", "Increased sun sensitivity", "Yeast infections"]
            }
        ],
        outlook: "Generally good, but can be a lifelong condition.",
        duration: "Can persist for years, but severity can fluctuate.",
        aggravatingFactors: ["Hormonal changes", "Genetics", "Stress", "Certain medications"]
    },
    {
        ...
        outlook: "Generally good with treatment, but recurrence is possible.",
        duration: "Symptoms typically resolve within a few days to a week with treatment.",
        aggravatingFactors: ["Poor hygiene", "Dehydration", "Sexual intercourse", "Kidney stones"]
    },
    {
        name: "Psoriasis",
        description: "A chronic autoimmune condition that causes the rapid buildup of skin cells, resulting in scaling on the skin's surface.",
        treatments: [
            {
            ...
            },
            {
                name: "Biologic Drugs",
                effectiveness: 85,
                sideEffects: ["Increased infection risk", "Injection site reactions", "Fatigue"]
            }
        ],
        outlook: "Chronic condition, but symptoms can be managed with treatment.",
        duration: "Lifelong condition, but severity can fluctuate.",
    ...
    {
        name: "Impetigo",
        description: "A common and highly contagious skin infection that mainly affects infants and children.",
        treatments: [
            {
        ...
        outlook: "Generally good with treatment, but can spread easily if left untreated.",
        duration: "Typically resolves within a few weeks with treatment.",
        aggravatingFactors: ["Close contact with infected individuals", "Poor hygiene", "Breaks in the skin"]
    }
];
